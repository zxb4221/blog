<?php
    ...
    if ($type == -1){
    	$q = "select count(a.id) from blog a, blog_type b where a.type_id=b.id and b.base='mysql'";
    }else{
    	$q = "select count(a.id) from blog a, blog_type b where a.type_id=b.id and b.base='mysql' and type_id=$type";
    }
