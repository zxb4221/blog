...
<body class="holygrail pg-index">
	...
	<div class="holygrail-body">
		...
		<div class="nav-bar-tabs">
			<nav>
				<span class="nav-bar-tab current"> <a class="current" href="/">最新文章</a></span> 
				<span class="nav-bar-tab"> <a href="/catalogView.php">目录视图</a></span>
				<span class="nav-bar-tab"> <a href="/about.html">关于博主</a></span>
			</nav>
		</div>
	</div>
	<div class="main">
		...
		<section id="section_container" class="post-list">
			<div id="article_view">
				<?php include_once("indexEx.php") ?>
			</div>
			<footer class="more"><span class="rectangle"><a href="/?l=40" class="btn">查看更多</a></span>
			</footer>
		</section>
	</div>
</div>
